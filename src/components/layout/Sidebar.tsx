...
const Sidebar = () => {
    ...
    return (
        ...
        <div className='h-fit'>
            <div className={`flex flex-col ${opened ? "gap-6" : "gap-0"} sm:gap-8 transition-all duration-300  p-4 sm:p-8 py-2 sm:py-12 rounded-3xl sm:rounded-lg text-white`} style={{ background: 'linear-gradient(90deg, #51ADC6 0%, #006E9F 100%)' }}>
