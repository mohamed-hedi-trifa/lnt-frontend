...
export default function EventDetailslImage({ event }: { event: IEvent | undefined }) {
  ...
  const generateGoogleCalendarUrl = (event: IEvent) => {
    ...
    const startDateStr = new Date(event_start_at).toISOString().replace(/-|:|\.\d\d\d/g, "");
    const endDateStr = new Date(event_end_at).toISOString().replace(/-|:|\.\d\d\d/g, "");
      ...
      <div className="relative text-start sm:block hidden">
        ...
        <div className="absolute left-[40px] bottom-[40px] right-[60px] sm:bottom-[70px] sm:left-[70px] text-white max-w-lg flex flex-col gap-3 sm:gap-6">
          <div className="flex flex-col gap-5">
            ...
            <h4 className="text-2xl italic" style={{ textShadow: "3px 3px rgba(0, 0, 0, 0.3)" }}>
      ...
      <div className="relative text-start sm:hidden block">
        ...
        <div className="absolute px-3 left-[40px] bottom-[20px] right-[60px] sm:bottom-[70px] sm:left-[70px] text-white max-w-lg flex flex-col">
          <div className="flex flex-col gap-3 items-center">
            ...
            <h4 className="text-xl italic text-center font-semibold" style={{ textShadow: "3px 3px rgba(0, 0, 0, 0.3)" }}>
              {event.description}
            </h4>
            <div className="flex items-center sm:gap-4 gap-2">
              <div className="flex flex-col items-center">
