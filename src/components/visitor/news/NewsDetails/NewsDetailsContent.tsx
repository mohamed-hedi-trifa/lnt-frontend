...
export default function NewsDetailsContent({ location, params }: { location: any; params: any }) {
        ...
        <div className="w-full">
            <div className="w-full px-8 text-start max-w-3xl mx-auto" dir={language === "ar" ? "rtl" : "ltr"}>
                ...
                <div className="flex flex-col gap-5">
                    <h2 className="text-[36px] font-semibold ">{news.title_en || news.title_fr}</h2>
                    ...
                    <div className="flex items-center gap-2 font-semibold text-sm">
                        <Calendar />
                        Le {new Date(news.date).toLocaleDateString("fr-FR", {
                            day: "numeric",
                            month: "long",
                            year: "numeric",
                        })}
