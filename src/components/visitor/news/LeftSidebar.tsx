...
export default function LeftSidebar() {
  return (
    <aside>
    <div className='opacity-90 sm:opacity-100  bg-white flex flex-col py-[30px] p-[10px] gap-4 sm:gap-10 w-full sm:w-[320px] rounded-xl shadow-xl overflow-y-auto pointer-events-auto h-fit'>
