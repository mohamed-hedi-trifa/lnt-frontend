...
export default function NewsCard({ image, category, title, date }: { image: string, category: string, title: string, date: string }) {
    return (

<div className='flex justify-between flex-col bg-white shadow-xl  px-5 py-5 gap-4 items-start'>
        ...
        <div className='  flex flex-col justify-start items-start gap-3'>
            ...
            <div className="sm:text-sm sm:leading-6 font-bold drop-shadow-md text-start">
                {title}
            </div>
         ...
         <span className="uppercase font-light text-sm ">{date}</span></div>
    );
};
