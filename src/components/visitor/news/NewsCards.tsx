    ...
    return (
        <section className='flex flex-col gap-8 w-full relative z-10 my-5 sm:my-10 col-span-1'>
            ...
            <div className='grid sm:grid-cols-2 gap-4 px-4 sm:px-0'>
                ...
                <NewsCard image={recentArticle1} category="Formation" title="Formation sur les fondamentaux de la gestion des aires marines protégées (MPA) organisée par MedPAN en Turquie" date="Le 4 octobre 2024" />

                <NewsCard image={recentArticle2} category="Initiative scientifique" title="Lancement d'une initiative scientifique pour protéger les tortues marines à Kerkennah" date="Le 4 octobre 2024" />
                <NewsCard image={recentArticle1} category="Formation" title="Formation sur les fondamentaux de la gestion des aires marines protégées (MPA) organisée par MedPAN en Turquie" date="Le 4 octobre 2024" />

                <NewsCard image={recentArticle2} category="Initiative scientifique" title="Lancement d'une initiative scientifique pour protéger les tortues marines à Kerkennah" date="Le 4 octobre 2024" />
                <NewsCard image={recentArticle1} category="Formation" title="Formation sur les fondamentaux de la gestion des aires marines protégées (MPA) organisée par MedPAN en Turquie" date="Le 4 octobre 2024" />

                <NewsCard image={recentArticle2} category="Initiative scientifique" title="Suivi du Pinna nobilis (Grande Nacre) à Kerkennah" date="Le 4 octobre 2024" />
                <NewsCard image={recentArticle1} category="Formation" title="Formation sur les fondamentaux de la gestion des aires marines protégées (MPA) organisée par MedPAN en Turquie" date="Le 4 octobre 2024" />
