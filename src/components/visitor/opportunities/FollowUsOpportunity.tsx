...
export default function FollowUsOpportunity() {
  return (
    <div className='sm:w-[300px] float-end'>
      ...
      <div className={`flex flex-col gap-6 sm:sticky top-[116px] h-fit   mt-8`}>
        ...
        <NewsLetterSub2 title="Restez Informé !" paragraph="Recevez les dernières offres directement dans votre boîte mail"/>
      </div>
