...
export default function InternshipOpportunityFormModal({ show, hide,  opportunityId = ""  }: { show: boolean, hide: () => void,  opportunityId: number | ""  }) {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        setIsLoading(true);
        try {
            const response = await axios.post("/api/submit-internship", formDataToSend, {
                headers: {
