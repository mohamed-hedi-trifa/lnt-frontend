...
const PreviousEditionCard: React.FC<CardProps> = ({ titre, description, lieu, date, slug }) => {
    return (

        <div className="  bg-white rounded-xl py-3 px-4   relative  flex w-full shadow-helmi gap-3 mt-3 flex-col sm:flex-row">
            ...
            <div className=" shrink-0 relative  sm:w-fit w-full" >
                ...
                <span className="absolute text-[#0270A0] top-2 left-2 bg-white px-2 py-1 text-sm rounded-md font-semibold">Édition 2024</span>
            </div>
