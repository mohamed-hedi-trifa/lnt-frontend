...
import TitleSectionEvent from '../../Event/TitleSectionEvent';
...
export default function FollowUsPreviousEdition() {
  return (
    <div className='sm:w-[300px] float-end'>
      ...
      <div className={`flex flex-col gap-6 sm:sticky top-[116px] h-fit   mt-8`}>
        ...
        <NewsLetterSub2 title="Ne manquez rien !" paragraph="Inscrivez-vous à notre newsletter pour être informé des prochains Festivals  "/>
      </div>
