...
export default function OurValues() {
    ...
    return (
        <div className=''>
            ...
            <section>
                <div className='max-w-6xl mx-auto'>
                    ...
                    <Value
              title={"Durabilité"}
              imageUrl={"/images/principes/principe1.png"} titlesrc={"/images/planete.png"} 
        ...
        <Value
              ...
              titlesrc={"/images/planete2.png"} description={"Nous croyons en la force de notre communauté pour conduire le changement et pérenniser les pratiques durables. En soutenant l’entrepreneuriat local, en particulier dans la pêche et l’artisanat, nous renforçons les capacités locales tout en préservant le savoir-faire ancestral de l’archipel."}     />

        <Value
              title={"Transparence"}
              imageUrl={"/images//principes/principe3.png"}
              titlesrc={"/images/planete3.png"} 
