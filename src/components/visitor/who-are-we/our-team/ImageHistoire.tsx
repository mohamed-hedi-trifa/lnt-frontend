...
const HistoryCard = ({ image, title, description }:{image:string, title:string, description:string}) => {
  return (
    <div className="w-full rounded-[10px] relative group">
      ...
      <div className="absolute inset-0 flex justify-center items-end pb-3 px-[33px] group-hover:flex">
        <div className="bg-white bg-opacity-70 p-4 rounded-lg shadow-lg transition-all duration-500 ease-in-out overflow-hidden max-h-[82px] group-hover:max-h-[300px]">
...
const ImageHistoire = () => {
  ...
  const data = [
    { title: "Notre Histoire", description: "Aire Marine et Côtière Protégée des ilots nord de l'archipel de Kerkennah (AMCP) ..." },
    { title: "Principes et Valeurs", description: "Aire Marine et Côtière Protégée des ilots nord de l'archipel de Kerkennah (AMCP) ..." },
    { title: "Nos Réalisations", description: "Aire Marine et Côtière Protégée des ilots nord de l'archipel de Kerkennah (AMCP) ..." },
    { title: "Notre Équipe", description: "Aire Marine et Côtière Protégée des ilots nord de l'archipel de Kerkennah (AMCP) ..." },
    { title: "Partenaires", description: "Aire Marine et Côtière Protégée des ilots nord de l'archipel de Kerkennah (AMCP) ..." },
  ];
