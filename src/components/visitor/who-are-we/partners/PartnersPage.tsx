...
export default function PartnersPage() {
    ...
    return (
        <div className=''>
            <img className='w-full object-cover h-[80vh]' src={partnersHero} />
