...
export default function FollowUsAchivement() {
  return (
    <div className='sm:w-[300px] float-end'>
      ...
      <div className={`flex flex-col gap-6 sm:sticky top-[116px] h-fit   mt-8`}>
        ...
        <NewsLetterSub2 title="Ne manquez rien !" paragraph="Inscrivez-vous à notre newsletter pour recevoir les dernières nouvelles sur nos réalisations et projets directement dans votre boîte mail"/>
      </div>
