          ...
          <section className="w-full flex flex-col sm:flex-row relative gap-4 md:gap-8 ms:py-10 pb-10">
            ...
            <section className="w-fit flex flex-col gap-8 ">
              <article className="flex flex-col gap-5">
                ...
                <div className="font-semibold text-[24px] sm:text-[28px] italic text-center sm:text-start">Une Analyse de Nos Ecosystémes Sous-Marins</div>
              ...
              <article className="flex flex-col gap-5">
                ...
                <img src="/images/marine_images/marine5.jpg" alt="Aire marine" className="w-full max-w-[600px] mx-auto h-auto rounded-lg shadow-lg" />
              </article>
              ...
              <article className="flex flex-col gap-5">
                ...
                <PageParagraph><List items={listMethodologie} /></PageParagraph>

                <img src="/images/marine_images/marine6.jpg" alt="" className="w-full max-w-[600px] mx-auto h-auto rounded-lg shadow-lg" />
              </article>
              ...
              <article className="flex flex-col gap-5">
                ...
                <img src="/images/marine_images/marine7.jpg" alt="" className="w-full max-w-[600px] mx-auto h-auto rounded-lg shadow-lg" />
              </article>
            </section>
          </section>
