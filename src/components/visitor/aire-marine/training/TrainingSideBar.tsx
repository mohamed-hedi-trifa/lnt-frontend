...
const TrainingSideBar = memo(function LeftSidebar({
    isSticky = true,
    lang,
    handleTypeChange,
    selectedType,
            ...
            >
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <Checkbox
                        name="formation"
                        label="Formation"
                        checked={selectedType === 'formation'}
                        
                        onChange={(c) => handleTypeChange('formation', c)}
                    />
                    <Checkbox
                        name="campement"
                        label="Campement Scientifique"
                        checked={selectedType === 'campement'}
                        onChange={(c) => handleTypeChange('campement', c)}
                ...
                {/* themes */}
                {/* Thèmes */}
                {(selectedType === 'formation' || selectedAllTypes) && (
