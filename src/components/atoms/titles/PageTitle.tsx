...
export default function PageTitle({ title, color, fontSize="text-4xl sm:text-[48px]", spacing }: { title: string | ReactNode, color?:string, fontSize?:string, spacing?:string }) {
    return (
