                                    ...
                                    {itemsList?.map((item: any) => {
                                        return (
                                            ...
                                            <div key={item.id} className="mx-0 grid grid-cols-12 text-center break-all">
                                                ...
                                                <div className='pt-3 text-start col-span-6 sm:col-span-4'><div className='font-bold'>{item.title_en || item.title_fr}</div> </div>
                                                ...
                                                <div className='pt-3 text-end sm:text-center col-span-1 sm:col-span-2'>
                                                    <div className='grid grid-cols-12'>
                                                        <div className='col-span-12 sm:col-span-6 flex justify-end sm:justify-center'><Link className='text-center' to={`/admin/posts/${item.slug}`} ><PencilSquareIcon className="block h-8 w-8 text-blue-600" aria-hidden="true" /></Link></div>
