...
const BlogGallery = ({ speciesId }: { speciesId: any }) => {
    ...
    const fetchMedia = async () => {
        try {
            const response = await axios.get(`/api/species/${speciesId}/media`);
    ...
    const addMedia = async () => {
        ...
        formDataToSend.append("species_id", speciesId);
        ...
        try {
            const response = await axios.post("/api/species/media", formDataToSend, {
