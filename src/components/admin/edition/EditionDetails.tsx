...
export default function EditionDetails({ params }: { params: any }) {
  ...
  const deletePartner = (e: any, item: any) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`/api/edition/${edition.id}/partner/${item.id}`)
          .then((res) => {
    ...
    <div className="container mx-auto p-6">
      {loading ? (
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <div>
            ...
            <form onSubmit={handleAddPartner} className="flex flex-col sm:flex-row items-center gap-4">
              ...
              >
                ...
                {edition.partnersnotselect.map((item: any) => (
          ...
          <EditionGallery editionId={edition.id} />
        </div>
      ) : (
