...
const EditionGallery = ({ editionId }: { editionId: any }) => {
    ...
    const fetchMedia = async () => {
        try {
            const response = await axios.get(`/api/edition/${editionId}/media`);
            console.log("API Response:", editionId);
    ...
    const addMedia = async () => {
        ...
        formDataToSend.append("edition_id", editionId);
        ...
        try {
            const response = await axios.post("/api/add-edition-media", formDataToSend, {
    ...
    const deleteMedia = async (id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios
                    .delete(`/api/remove-edition-media/${id}`)
                    .then((res) => {
