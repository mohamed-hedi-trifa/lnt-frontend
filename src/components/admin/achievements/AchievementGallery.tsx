...
const AchievementGallery = ({ achievementId }: { achievementId: any }) => {
    ...
    const fetchMedia = async () => {
        try {
            const response = await axios.get(`/api/achievement/${achievementId}/media`);
            console.log("API Response:", achievementId);
    ...
    const addMedia = async () => {
        ...
        formDataToSend.append("achievement_id", achievementId);
        ...
        try {
            const response = await axios.post("/api/add-achievement-media", formDataToSend, {
    ...
    const deleteMedia = async (id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios
                    .delete(`/api/remove-achievement-media/${id}`)
                    .then((res) => {
