...
const PreviousEventGallery = ({ previousEventId }: { previousEventId: any }) => {
    ...
    const fetchMedia = async () => {
        try {
            const response = await axios.get(`/api/previous-event/${previousEventId}/media`);
    ...
    const addMedia = async () => {
        ...
        formDataToSend.append("previous_event_id", previousEventId);
        ...
        try {
            const response = await axios.post("/api/add-previous-event-media", formDataToSend, {
    ...
    const deleteMedia = async (id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios
                    .delete(`/api/remove-previous-event-media/${id}`)
                    .then((res) => {
