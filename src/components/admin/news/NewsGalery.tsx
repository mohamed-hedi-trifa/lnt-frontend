...
const NewsGallery = ({ newsId }: { newsId: any }) => {
    ...
    const fetchMedia = async () => {
        try {
            const response = await axios.get(`/api/news/${newsId}/media`);
            console.log("API Response:", newsId);
    ...
    const addMedia = async () => {
        ...
        formDataToSend.append("news_id", newsId);
        ...
        try {
            const response = await axios.post("/api/add-news-media", formDataToSend, {
    ...
    const deleteMedia = async (id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios
                    .delete(`/api/remove-news-media/${id}`)
                    .then((res) => {
    ...
    return (
        <div className="p-6 max-w-2xl mx-auto">
            <h2 className="text-2xl font-bold mb-4">News Gallery</h2>
