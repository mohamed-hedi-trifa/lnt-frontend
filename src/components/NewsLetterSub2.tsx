...
export default function NewsLetterSub2() {
              ...
              <div className="w-[259.95px] flex-col justify-start items-center gap-[25px] inline-flex">
                <div className="flex-col justify-start items-center gap-px flex">
                  <div className="w-[231px] h-[75px] relative">
                    <div className="w-[231px] h-[29px] left-0 top-[22.10px] absolute text-center text-white text-2xl font-extrabold font-['Manrope'] capitalize leading-7">Restez Connectés !</div>
                    <div className='flex justify-center'><EnveloppeIcon /></div>
                  </div>
                  <div className="w-[218px] text-center text-white text-base font-medium font-['Inter'] capitalize leading-7">Inscrivez-vous à notre newsletter pour Recevez les infos sur nos prochaines formations et campements</div>
                </div>
